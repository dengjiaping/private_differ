...
//        }
        ...
        contentTextColor = typedArray.getColor(R.styleable.ExpandableTextView_contentTextColor, ContextCompat.getColor(getContext(), R.color.bg_gray_text));
        contentTextSize = typedArray.getDimension(R.styleable.ExpandableTextView_contentTextSize, CommonUtil.sp2px(getContext(),14));
        ...
        collapseExpandTextSize = typedArray.getDimension(R.styleable.ExpandableTextView_collapseExpandTextSize, CommonUtil.sp2px(getContext(),14));
//
