...
public class JCVideoView extends JCVideoPlayer {
    ...
    public void init(Context context) {
        ...
        mBtnSound = (ImageView) findViewById(R.id.sound);
...
//        mBtnSound.setImageResource(volume <= 0 ? R.drawable.ic_video_mute : R.drawable.ic_video_play);
    }
    ...
    public int getLayoutId() {
        return R.layout.layout_jc_video_view;
    }
    ...
    public void onClick(View v) {
        ...
        if (i == R.id.thumb) {
            ...
            backPress();
            mBtnSound.setImageResource(R.drawable.ic_video_mute);
            ...
            if (volume <= 0) {
                ...
                mBtnSound.setImageResource(R.drawable.ic_video_play);
            } else {
